...
function Stars({ rating }: { rating: number }) {
  return (
    <div className="flex gap-0.5 text-[#F4C2C2]" aria-label={`${rating} av 5 stjärnor`}>
...
export default function ReviewsCarousel() {
  ...
  return (
    <section id="omdomen" className="bg-[#7B4B6F] py-20 text-white">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="mx-auto max-w-2xl text-center">
          <p className="text-sm font-semibold uppercase tracking-wider text-[#F4C2C2]">Omdömen</p>
        ...
        <div className="mt-10 text-center">
          <a
            ...
            className="inline-flex items-center justify-center rounded-full bg-[#F4C2C2] px-8 py-3 text-sm font-semibold text-[#4A2D42] transition hover:bg-[#e0a8a8]"
          >
